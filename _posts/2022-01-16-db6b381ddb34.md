...
透過原型鏈，字串 `name` 可以取用 String\.prototype 裡定義好的方法，像是 `.split()` , `.slice()` , `.toLowerCase()` 等字串方法： [更多字串方法](https://developer.mozilla.org/zh-TW/docs/Web/JavaScript/Reference/Global_Objects/String#)
```
